...
if __name__ == "__main__":
    dictPath = "" # paste jieba's dict path
    datasetPath = "" # paste the path of the dataset which you want to use
    embeddingPath = "" # paste the path of embedding which is generated by preproccessing.py
    tf = tfidf(dictPath, datasetPath, embeddingPath)
    print(tf.search("洗錢會怎樣"))